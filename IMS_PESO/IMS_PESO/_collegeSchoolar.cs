...
namespace IMS_PESO
{
    public partial class _collegeSchoolar : Form
    {
        DBConn DB = new DBConn();
        public _collegeSchoolar()
        {
            try
            {
                DB.getDataSource();
        ...
        private void textBox1_Leave(object sender, EventArgs e)
        {
            ...
            //    if (myreader.Read())
            //    {
            //        MessageBox.Show(this, "This code already exist please change event title :-)", "Peter Says", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //        label9.Focus();
            //    }
            //}
            //catch (Exception ex)
        ...
        {
            _collegeSchoolarFilter a = new _collegeSchoolarFilter();
            a.ShowDialog();
        }
