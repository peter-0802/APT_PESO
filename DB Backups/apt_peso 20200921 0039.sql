...
INSERT INTO `hsshcoolar` (`id`,`event_date`,`surname`,`firstname`,`middlename`,`gender`,`school`,`yearlevel`,`barangay`,`notes`) VALUES 
 (1,'2020-09-16','asd','dsa','asd','Female','NEW KATIPUNAN NHS','Grade 9','MABINI','notes'),
 (2,'2020-09-16','asdsad','ssdad','sasda','Male','MAGSAYSAY ACADEMY, INC.','Grade 10','MAIBO','notes'),
 (3,'2020-09-24','ad','dsa','asd','Male','NEW KATIPUNAN NHS','Grade 10','LOWER BALA','notes'),
 (4,'2020-09-24','ada','dsad','sdasd','Female','SALUD CAGAS TVHS','Grade 11','KASUGA','notes'),
 (5,'2020-09-26','imboy','peter','eni','Female','MAGSAYSAY ACADEMY, INC.','Grade 12','KANAPOLO','notes');
...
INSERT INTO `ofw` (`id`,`date`,`code`,`surname`,`firstname`,`middlename`,`address`,`country`,`passport`,`contact_no`,`status`,`remarks`) VALUES 
 (1,'2020-09-15','OFW - 1','IMBOY','PETER JAY','ENCINARES','BANSALAN, DAVAO DEL SUR','CANADA','PASSPORT','CONTACT','INACTIVE','ABUSED');
